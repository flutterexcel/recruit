...
class AppColors {
  static const Color WARINING_LIGHT = Color(0xFFF8E1B4);
  static const Color Orange = Color(0xFFF6A609);
  static const Color Light_Orange = Color(0xFFF8E1B4);
  static const Color Primary = Color(0xFF007EFF);
  static const Color Black = Color(0xFF3D3D3D);
  static const Color IconBackground = Color(0xFFE0E0E0);
  static const Color Grey = Color(0xFFA6AAB4);
  static const Color Light_Grey = Color(0xFFE0E2E7);
  static const Color Grey_Font = Color(0xFF757575);
  static const Color Grey_Box = Color(0xFFBDBDBD);
  static const Color Grey_BackGround = Color(0xFFECECEC);
  static const Color Navigation_Text = Color(0xFF5E5E5E);
  static const Color Yello_Box = Color(0xFFFFC627);
  static const Color Red = Color(0xFFE55934);
  static const Color Light_Red = Color(0xFFF3C2C2);
  static const Color Icon_Color = Color(0xFFA6AAB4);
  static const Color Blue = Color(0xFF007EFF);
  static const Color Light_Blue = Color(0xFFAED5FE);
  ...
  static Color pink = Color(0xFFF96AC9);
}
