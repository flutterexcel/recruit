...
class Add_Referral_Email_Service {
  static Future<CreateReferral> addReferralEmail(String email) async {
    ...
    if (response.statusCode == 200) {
      print("Success");
      return CreateReferral.fromJson(jsonDecode(response.body));
    } else {
      print("error");
