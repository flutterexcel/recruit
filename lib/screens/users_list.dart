...
import 'package:flutter_product_recruit/services/get_userlist_service.dart';
...
class _User_ListState extends State<User_List> {
  ...
  void getUserList() async {
    var res = await GetUserList.getUserList();
    data = res;
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => Add_New_User()));
                },
              ),
            ),
          ),
            ...
            child: Contain(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Textt(
                    text: data[index].userType.toString(),
                    size: 13,
